      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Container(
            height: 50,
            child: Center(
              child: Text(terms_condition,
                  style: kLabelStyleBold.apply(color: kGrey)),
            ),
          ),
        ),
      ),
      ...
      child: RaisedButton(
        onPressed: () {
          if (_formKey.currentState.saveAndValidate()) {
            ...
            _userMaster.phoneNumber = _emailController.text.trim().toString();
            _userMaster.password = _passwordController.text.trim().toString();
            _userMaster.otp = _passwordController.text.trim().toString();
            _userMaster.userTypeId = "3";
            _userBloc.add(UserRegistrationEvent(userMaster: _userMaster));
          }
        },
        color: kBlack,
